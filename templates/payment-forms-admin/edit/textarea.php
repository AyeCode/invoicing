<?php
/**
 * Displays a textarea setting in the payment form editor
 *
 * This template can be overridden by copying it to yourtheme/invoicing/payment-forms-admin/edit/textarea.php.
 *
 * @version 1.0.19
 */
