<?php
/**
 * Displays an email preview in the payment form editor
 *
 * This template can be overridden by copying it to yourtheme/invoicing/payment-forms-admin/previews/email.php.
 *
 * @version 1.0.19
 */
