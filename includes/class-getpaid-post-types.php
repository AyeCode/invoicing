			...
			apply_filters(
				...
				array(
					'labels'                 => array(
						...
						'singular_name'         => __( 'Item', 'invoicing' ),
						'all_items'             => __( 'All Items', 'invoicing' ),
						'menu_name'             => _x( 'Items', 'Admin menu name', 'invoicing' ),
						...
						'view_items'            => __( 'View items', 'invoicing' ),
						...
						'parent'                => __( 'Parent item', 'invoicing' ),
						'featured_image'        => __( 'item image', 'invoicing' ),
						'set_featured_image'    => __( 'Set item image', 'invoicing' ),
						'remove_featured_image' => __( 'Remove item image', 'invoicing' ),
						'use_featured_image'    => __( 'Use as item image', 'invoicing' ),
						'insert_into_item'      => __( 'Insert into item', 'invoicing' ),
						'uploaded_to_this_item' => __( 'Uploaded to this item', 'invoicing' ),
						'filter_items_list'     => __( 'Filter items', 'invoicing' ),
						'items_list_navigation' => __( 'Items navigation', 'invoicing' ),
						'items_list'            => __( 'Items list', 'invoicing' ),
					),
			...
			apply_filters(
				...
				array(
					'labels'                 => array(
						...
						'all_items'             => __( 'All Invoices', 'invoicing' ),
			...
			apply_filters(
				...
				array(
					'labels'                 => array(
						...
						'all_items'             => __( 'All Discounts', 'invoicing' ),
