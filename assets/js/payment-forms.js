...
jQuery(function ($) {
        ...
        return {
            ...
            show_error: function show_error(error) {
                ...
                form
                    ...
                    .html(error)
                    .removeClass("d-none"); // Animate to the error
            ...
            process_gateways: function process_gateways(enabled_gateways, state) {
                ...
                this.form
                    .find(".getpaid-no-recurring-gateways, .getpaid-no-active-gateways")
                    .addClass("d-none");
                this.form
                    .find(
                ...
                $.each(enabled_gateways, function (index, value) {
                    _this3.form.find(".getpaid-gateway-" + value).removeClass("d-none");
                }); // If there is no gateway selected, select the first.

                if (
                    0 === this.form.find(".getpaid-gateway-radio input:checked").length
                ) {
                    this.form
    ...
    var setup_form = function setup_form(form) {
        ...
        form
            .find(".getpaid-gateway-description-div .form-horizontal .form-group")
        ...
        getpaid_form(form).init(); // Discounts.
    ...
    $(document).on("click", ".getpaid-payment-button", function (e) {
        ...
        $("#getpaid-payment-modal .modal-body").html(
