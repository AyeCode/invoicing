 ...
 * @subpackage Invoicing_Paypal_Pro/public
 */
 ...
 */
class Invoicing_Paypal_Pro_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/invoicing-paypal-pro-public.css', array(), $this->version, 'all' );
	}
	...
	public function enqueue_scripts() {
        ...
        public function paypalpro_form($invoice_id){
            require_once 'partials/invoicing-paypal-pro-public-display.php';
        }
}
